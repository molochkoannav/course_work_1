...
from src.utils import get_date_period
from src.utils import get_filtred_info
from src.utils import get_read_excel_file
from src.utils import get_read_file
from src.utils import get_stocks
from src.utils import get_stocks_info
from src.utils import get_top_five
...
class TestUtils(unittest.TestCase):
    ...
    def test_get_read_excel_file(self, mock_read_excel):
        ...
        test_data = pd.DataFrame(
            {"Дата операции": ["01.12.2021", "10.12.2021", "20.12.2021", "15.12.2021"], "Сумма": [100, 200, 300, 400]}
        )
    ...
    def test_get_read_excel_file_empty_result(self, mock_read_excel):
        ...
        test_data = pd.DataFrame({"Дата операции": ["01.01.2021", "02.01.2021"], "Сумма": [100, 200]})
        test_data["Дата операции"] = pd.to_datetime(test_data["Дата операции"], dayfirst=True)
    ...
    def test_get_currency_rates_success(self, mock_get):
        ...
        mock_response.json.return_value = {"Valute": {"USD": {"Value": 50}, "EUR": {"Value": 100}}}
