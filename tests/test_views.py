...
class TestViews:
    ...
    def test_main_info_success(
        ...
        mock_get_top_five.return_value = [
            {"date": "08.12.2021", "amount": 3500.00, "category": "Электроника", "description": "Покупка техники"},
            {"date": "05.12.2021", "amount": 1500.50, "category": "Супермаркеты", "description": "Покупка в магазине"},
        ]
        mock_get_read_file.return_value = {"currencies": ["USD", "EUR"], "stocks": ["AAPL", "GOOGL"]}
